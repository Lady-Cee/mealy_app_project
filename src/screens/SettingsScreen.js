      ...
      <Text style={{marginTop:40, marginLeft:18, fontSize:16}}>Account </Text>
         ...
         >
              ...
              <View style={{flexDirection:'row', position:'absolute', top:12}}>
                  ...
                  <Image source={require('../../assets/profilescreenlist/image-editing.png')}
         ...
         >
              ...
              <View style={{flexDirection:'row', position:'absolute', top:12}}>
                <View style={{marginLeft:15}}>
                  ...
                  <Image source={require('../../assets/profilescreenlist/on-button.png')}
         ...
         >
              ...
              <View style={{flexDirection:'row', position:'absolute', top:12}}>
              <View style={{marginLeft:15}}>
                  <Image source={require('../../assets/profilescreenlist/bag.png')}
                    style={{width:25, height:25,tintColor:'black' }}/>  
                  </View> 
                    <View style={{marginLeft:20}}>
                  ...
                  <Image source={require('../../assets/profilescreenlist/rytarrow.png')}
                    style={{width:8, height:8, tintColor:"gray" }}/>  
                  </View> 
              </View> 
